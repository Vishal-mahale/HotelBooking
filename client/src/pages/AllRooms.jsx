...
function AllRooms() {
  ...
  const priceRanges = ["0-500", "500-100", "1000-2000", "2000-3000"];
  ...
  return (
    <div className="flex flex-col-reverse lg:flex-row items-start justify-between pt-28 md:pt-34 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="bg-white w-80 border border-gray-300 text-gray-600 max-lg:mb-8 min-lg:mt-16">
        <div
          className={`flex items-center justify-between px-2 py-2.5 min:lg-border-b border-gray-300 ${openFilters && "border-b"}`}
        >
        ...
        >
          ...
          <div className="px-5 pt-5">
            ...
            {priceRanges.map((range, index) => (
              <CheckBox key={index} label={`$ ${range}`}></CheckBox>
            ))}
          </div>
