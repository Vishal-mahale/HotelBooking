      ...
      <div className=" bg-[#F6F9FC] text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32">
        <div className="flex flex-wrap justify-between gap-12 md:gap-6">
          <div className="max-w-80">
            ...
            <p className="text-sm">
              Discover the world's most extraordinary places, from boutique
              hotels to luxury villas to private islands.
            </p>
          ...
          <div className="max-w-80 font-playfair">
            ...
            <div className="flex items-center mt-4">
              ...
              />
              <button className="flex items-center justify-center h-9 w-9 aspect-square rounded-r bg-[#9ea1a5]">
                {/* Arrow icon */}
